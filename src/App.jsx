    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Anu isvarya A loosu paithiyam</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Anu isvarya A loosu paithiyam's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">TATA BYEBYE SEE YOU DRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR</h2>
        </section>
      </div>
